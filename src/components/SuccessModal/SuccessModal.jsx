  ...
  return (
    <Dialog open={open} onOpenChange={onClose} className="bg-[#FFF1C5]">
      <DialogContent className="bg-[#FFF1C5] border-none shadow-lg w-[90%] h-[51%] rounded md:w-[700px] md:h-[300px]">
        ...
        {/* Modal content */}
        <DialogHeader>
          <DialogTitle className=" text-[24px] md:text-[42px] font-fraunces leading-normal font-bold text-customBlue text-center mb-6">
        ...
        <DialogFooter className="hidden sm:block mt-11 bg-customYellow h-[35px] rounded-b-full"></DialogFooter>
      </DialogContent>
    </Dialog>
  );
}
