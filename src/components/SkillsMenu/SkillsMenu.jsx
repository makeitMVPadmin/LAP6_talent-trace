...
function SkillsMenuCard({ onButtonClick }) {
  ...
  return (
    <>
      <Card className="Skills_Menu flex flex-col bg-white w-full md:w-[38.813rem] h-auto md:h-[60.188rem] md:p-[3rem] border-white shadow-none md:rounded-[1.25rem] md:border-customBlue justify-center">
        <CardHeader>
