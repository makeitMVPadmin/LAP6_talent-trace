...
function SnapMain({ id, badges, content }) {
  return (
    <div className="snapshot__center max-xl:hidden flex-1 bg-[url('/src/assets/images/snapshot_center_frame_3.png')] bg-no-repeat bg-center flex flex-col justify-between items-center">
      {/* Center Top Box */}
      <div className="snapshot__top w-full h-[240px] mt-[5px] pt-[15px] px-[45px] flex flex-col items-center">
      ...
      {/* Center Bottom Box */}
      <div className="snapshot__bot w-[520px] h-[245px] mb-[25px] pb-[20px] px-[37px] flex flex-col text-card-foreground">
        <div className="snapshot__bot-header">
          <h2 className="snapshot__heading font-serif font-semibold text-[0.75rem]">
            {content.question.question}
          </h2>
        </div>
        <div className="snapshot__bot-main flex flex-col pt-[10px] pb-[16px] gap-[15px]">
          <p className="snapshot__text font-sans xl:text-[0.65rem] font-medium flex-1">
            {content.answer}
          </p>
          <div className="flex flex-row gap-4">
            <div className="snapshot__media w-[240px]">
              <img
                src={content.image}
                className="snapshot__img h-[105px] w-[240px] rounded-[10px] border border-black object-cover"
              />
            </div>

            <div className="snapshot__skills flex flex-row gap-[9px] items-center">
