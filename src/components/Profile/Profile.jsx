      ...
      <div className="profile flex flex-row justify-center gap-[2rem] py-[4rem]">
        <div className="profile__left w-[33rem]">
          <div className="profile__intro flex flex-row justify-between">
            ...
            {/* Profile Name  */}
            <Card className="profile__greeting w-[15.5rem] h-[12.5rem] bg-zinc-100  rounded-[1.5rem]">
              <CardContent className="p-4 h-full flex flex-col justify-between">
                <p className="profile__opener font-serif text-xl font-semibold pt-[0.5rem]">
                  Hello 👋🏻 I’m
                </p>
                <div className="profile__titlebox">
                  ...
                  <h3 className="profile__role text-xl font-semibold text-neutral-600 font-serif pt-[0.5rem]">
                    Software Developer
                  </h3>
                </div>
              </CardContent>
          ...
          {/* Soft Skills  */}
          <Card className="profile__soft-skills w-full bg-zinc-100 mt-[1rem] rounded-[1.5rem] h-[13.75rem]">
            <CardHeader>
            ...
            <CardContent className="flex flex-row flex-wrap gap-[0.375rem] px-0 justify-center">
              <Badge
                className="profile__skill-badge bg-white rounded-[500px] mt-[0.5rem] h-[2rem] py-[0.25rem] w-[7.5rem] flex justify-center"
                variant="secondary"
              >
                Communicative
              </Badge>
          ...
          {/* Hard Skills  */}
          <Card className="profile__hard-skills w-full bg-zinc-100 mt-[1rem] rounded-[1.5rem] h-[13.75rem]">
            <CardHeader>
              <CardTitle className="profile__card-title text-[1.5rem]">
                Hard Skills
              </CardTitle>
            ...
            <CardContent className="flex flex-col gap-[0.6rem]">
              <div className="profile__skill-bar flex flex-row">
                ...
                <div className="profile__skill-slider w-[85%] bg-green-400 h-[0.75rem] border self-center"></div>
              </div>
              <div className="profile__skill-bar flex flex-row">
                <p className="profile__skill-name text-xs w-[15%] font-semibold">
                  Java
                </p>
                <div className="profile__skill-slider w-[70%] bg-green-400 h-[0.75rem] border self-center"></div>
              </div>
              <div className="profile__skill-bar flex flex-row">
                <p className="profile__skill-name text-xs w-[15%] font-semibold">
                  HTML
                </p>
                <div className="profile__skill-slider w-[25%] bg-green-400 h-[0.75rem] border self-center"></div>
              </div>
            </CardContent>
          </Card>
          {/* Tools Card  */}
          <Card className="profile__tools w-full bg-zinc-100 mt-[1rem] pb-[1.5rem] rounded-[1.5rem] h-[13.75rem]">
            <CardHeader>
              <CardTitle className="profile__card-title text-[1.5rem]">
                Tools
              </CardTitle>
            ...
            <div className="profile__tools-bar flex flex-row justify-evenly">
              <div className="profile__tools-left flex flex-col items-center -mt-[1.438rem]">
                <Badge className="profile__tools-badge bg-black text-white rounded-[500px] relative top-3">
                  Code
                </Badge>
                <Card className="profile__code bg-white w-[13.5rem] h-[6.5rem] rounded-[1.25rem] flex justify-center items-center">
                  <CardContent className="flex flex-row gap-[1rem] flex-wrap p-0">
                    <img
              ...
              <div className="profile__tools-right flex flex-col items-center -mt-[1.438rem]">
                ...
                <Card className="profile__design bg-white w-[13.5rem] h-[6.5rem] rounded-[1.25rem] flex justify-center items-center">
                  <CardContent className="flex flex-row gap-[1rem] flex-wrap p-0">
                    <img
                      src="/src/assets/icons/logo_figma.svg"
                      className="profile__icon"
          ...
          <Card className="profile__tools w-full bg-zinc-100 mt-[1rem] pb-[1.5rem] rounded-[1.5rem] h-[13.75rem]">
            ...
            <div className="profile__certifications-bar flex flex-row justify-evenly">
              <div className="profile__certifications-left flex flex-col items-center -mt-[1.438rem]">
                <Badge className="profile__certifications-badge bg-black text-white rounded-[500px] relative top-3">
                  Code
                </Badge>
                <Card className="profile__code bg-white w-[13.5rem] h-[6.5rem] rounded-[1.25rem] flex justify-center items-center">
                  <CardContent className="flex flex-row gap-[1rem] flex-wrap p-0">
          ...
          {/* Contact Card  */}
          <Card className="profile__contact bg-amber-400 mt-[1rem] rounded-[1.5rem]">
            <CardContent>
              <h2 className="profile__subtitle font-serif font-semibold text-white mt-[0.5rem] text-[1.5rem]">
                Let´s chat!
              </h2>
        ...
        <div className="profile__right w-[50rem] h-[1000px]">
          ...
          <Card className="profile__creator w-[50rem] bg-zinc-100 rounded-[1.5rem] flex flex-col items-center">
            ...
            <CardFooter>
              <button className="profile__creator-button bg-blue-600 h-[2.5rem] w-[14.5rem] text-[1.125rem] font-semibold rounded-[0.625rem] text-white">
                Create my Snapshot
              </button>
            </CardFooter>
          </Card>
          ...
          <Card className="profile__current w-[50rem] bg-zinc-100 rounded-[1.5rem] px-[1rem] mt-[1rem]">
            ...
            <CardContent>
              ...
              <Badge className="profile__current-badge rounded-[500px] mt-6">
                Badge
              </Badge>
            </CardContent>
          </Card>
